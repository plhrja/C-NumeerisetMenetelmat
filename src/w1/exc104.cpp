...
void fitExchangeRate(std::vector<double> xdata, std::vector<double> ydata, int size, double* a, double* b) {
...
int main() {
    ...
    std::vector<double> y = {0.8969, 0.9005, 0.8961, 0.8919, 0.8793, 0.8818};
    ...
    const char* filename1 = "data.tmp";
    const char* filename2 = "fitted.tmp";
